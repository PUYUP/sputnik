...
class CertificateListSerializer(ListSerializerUpdateMappingField, serializers.ListSerializer):
...
class CertificateSerializer(DynamicFieldsModelSerializer, WritetableFieldPutMethod,
