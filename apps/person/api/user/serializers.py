...
from apps.person.utils.constants import (
    CHANGE_EMAIL_VALIDATION, REGISTER_VALIDATION,
    CHANGE_MSISDN_VALIDATION, ROLE_IDENTIFIERS, ROLES_ALLOWED
)
...
from apps.person.api.education.serializers import EducationSerializer
from apps.person.api.certificate.serializers import CertificateSerializer
from apps.person.api.experience.serializers import ExperienceSerializer
